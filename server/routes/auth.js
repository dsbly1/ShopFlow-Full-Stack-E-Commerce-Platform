...
router.post('/forgot-password', async (req, res) => {
  ...
  await pool.query('UPDATE users SET reset_token=$1, reset_token_expires_at=$2 WHERE email=$3', [token, expires, email]);
...
router.post('/reset-password', async (req, res) => {
  ...
  await pool.query('UPDATE users SET password_hash=$1, reset_token=NULL, reset_token_expires_at=NULL WHERE id=$2', [hash, rows[0].id]);
